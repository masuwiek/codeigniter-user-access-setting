	...
	<div class="col-md-12">
		<div class="portlet box green">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?= base_url() ?>setting/user/add_user" class="btn default btn-sm"><i class="fa fa-plus"></i> Create a New User</a>
				</div>
			</div>
							...
							if(is_array($tablelist)){								
								...
								if($datacount > 0){
									foreach($tablelist as $obj){
										$number 	= $no + $pagecount;
										$id			= $obj->userid;
										$edit_url 	= base_url()."setting/user/edit_user/".$id;
										$del_url	= base_url()."setting/user/delete_user/".$id;
										$del_form 	= "delete_user".$id;
										$item_name	= "Username";
