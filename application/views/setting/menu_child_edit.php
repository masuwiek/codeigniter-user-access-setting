	...
	<div class="col-md-12">	
		...
		<div class="portlet box green">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?= base_url() ?>setting/menu/menu_child/<?= $parentid ?>" class="btn default btn-sm"><i class="fa fa-list-alt"></i> Back to Menu List</a>
				</div>
			</div>
			<div class="portlet-body form">	
				
				<form class="form-horizontal" method="post" role="form" action="<?= base_url() ?>setting/menu/edit_menu_child/<?= $menu->menuid ?>/<?= $parentid ?>">	
					...
					<div class="form-actions">
						<div class="row">
							<div class="col-md-offset-3 col-md-9">
								...
								<a href="<?= base_url() ?>setting/menu/menu_child/<?= $parentid ?>" type="button" class="btn red">Cancel</a>
							</div>
						</div>
					</div>
				</form>
