	...
	<div class="col-md-12">
		<div class="portlet box green">
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?= base_url() ?>setting/menu" class="btn default btn-sm"><i class="fa fa-list-alt"></i> Back to Parent Menu List</a>
					<a href="<?= base_url() ?>setting/menu/add_menu_child/<?= $parentid ?>" class="btn default btn-sm"><i class="fa fa-plus"></i> Create a New Child Menu</a>
				</div>
			</div>
							...
							if(is_array($tablelist)){								
								...
								if($datacount > 0){
									foreach($tablelist as $obj){
										...
										$id			= $obj->menuid;
										$edit_url 	= base_url()."setting/menu/edit_menu_child/".$id."/".$obj->menuparentid;
										$del_url	= base_url()."setting/menu/delete_menu_child/".$id."/".$obj->menuparentid;
										$del_form 	= "delete_menu_child".$id;
										$item_name	= "Menu";
